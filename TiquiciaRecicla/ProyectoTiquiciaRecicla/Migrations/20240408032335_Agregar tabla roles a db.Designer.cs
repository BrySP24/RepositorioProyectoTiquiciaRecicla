...
namespace ProyectoTiquiciaRecicla.Migrations
{
    ...
    [Migration("20240408032335_Agregar tabla roles a db")]
    partial class Agregartablarolesadb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProyectoTiquiciaRecicla.Models.CAT_Rol", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProyectoTiquiciaRecicla.Models.CAT_Rol", b =>
                {
                    b.HasOne("ProyectoTiquiciaRecicla.Models.CAT_Rol", null)
                        .WithMany("CAT_Roles")
                        .HasForeignKey("CAT_RolId");
                });
            ...
            modelBuilder.Entity("ProyectoTiquiciaRecicla.Models.TBL_Usuario", b =>
                {
                    ...
                    b.HasOne("ProyectoTiquiciaRecicla.Models.CAT_Rol", "CAT_Roles")
                        .WithMany()
                        .HasForeignKey("CAT_RolId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
